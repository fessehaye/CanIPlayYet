export const Steps = [
	{
		...
		content: 'Copy the slug from the Challonge bracket and paste it here. https://challonge.co' + 'm/<slug> should be the format.',
	},
	{
	...
	},
	{
		...
		content: 'Once you click check, a message will appear if there are available setups for fr' + 'ee play.',
	},
	{
		selector: '#loopTutorial',
		content: 'If you want to continuously check for updates, check this section and the update' + 's will occur every 30 seconds. This is for the TO use only!',
	},
	{
